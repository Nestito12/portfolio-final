...
<head>
    ...
    <title>Stock - Administration - Modifier une oeuvre</title>
</head>
<body>
<?php
...
<div class="container-fluid">
    <h1>Modifier l'oeuvre: <?= $don['name'] ?></h1>
    <a href="works.php" class="btn btn-secondary my-2">Retour</a>
    <div class="container">
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <!-- gestion des images associées -->
                 ...
                 <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                            $galery = $bdd->prepare("SELECT * FROM images WHERE id_works=?");
                            $galery->execute([$id]);
